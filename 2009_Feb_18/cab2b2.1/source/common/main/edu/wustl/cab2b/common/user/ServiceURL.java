...
public class ServiceURL implements ServiceURLInterface, Serializable {
     ...
     */
    private void setModelDescription(String modelDescription) {
    ...
    public String getDescription() {
        ...
        if (hostingCenter == null && description != null && !description.isEmpty()) {
            return "Description : " + description;
        } else if (hostingCenter != null && !hostingCenter.isEmpty() && description != null
                && !description.isEmpty()) {
