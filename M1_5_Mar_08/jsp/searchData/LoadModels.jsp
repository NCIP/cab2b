...
<%
    List<CaDSRModelDetailsBean> loadModel = (List) session.getAttribute(Cab2bConstants.FILTERED_AVAILABLE_MODELS_TO_LOAD);
    ...
    String isDisabled = "";
    Map<String, List<String>> allSelectedModelList =(Map<String, List<String>>) session.getAttribute(Cab2bConstants.ALL_SELECTED_MODELS_LIST);
 ...
 %>
						...
						<pg:item>
							<tr>
								...
								<td align="center" valign="top"><input type="checkbox"
									...
									value="<%=model.getLongName()%>" /></td>
								<td align="left"><span class="font_bl1_b" onmouseover="Tip('<%=descriptionWithoutComma%>',400,200)"><%=model.getLongName()%>
								</span><br />
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					&nbsp;
					&nbsp;&nbsp;&nbsp;<input name="Submit2" class="font_bl1_b"
						type="button" onclick="checkCheckbox(this.form.name);"
						<%=isDisabled%> value="Load Model" /> &nbsp;&nbsp;&nbsp;</td>
					<!--  </form>-->
				</tr>
			</table>
			</td>
