...
<%@page import="edu.wustl.cab2b.admin.beans.AdminServiceMetadata"%>
...
function back(pageNo,searchString)
{
 ...
 function setSelectedValues()
 {
    ...
    var boxNameArray = checkbox_names.split(":"); 
    var serviceName ="";
	for(i=1;i<boxNameArray.length-1;i++)
     {
      var chkname= boxNameArray[i]+"_checkbox";
      var checkbox11 = document.getElementById(chkname);
...
<%
            List<AdminServiceMetadata> records = (List) session.getAttribute(Cab2bConstants.FILTERED_SERVICE_INSTANCES);
...
%>					
                  ...
                  <tr>
                    <td width="25" align="center"><input type="checkbox" name="selectAll" value="checkbox" <%=selection%> onClick="selectAll(this.checked);"/></td>
...
<%
			if(records.size()>0)
			{
              for (int i = offset.intValue(), l = Math.min(i + maxPageItems, records.size()); i < l; i++) 
              {
                ...
                chkboxNames =chkboxNames+":"+metadata.getHostingResearchCenter();
					...
					<pg:item>                       
                  <tr>
                    <td align="center" valign="top"><input type="checkbox" name="checkedServiceInstances" value="<%=metadata.getHostingResearchCenter()%>"	id="<%=metadata.getHostingResearchCenter()%>_checkbox"/></td>
 ...
 <tr>
                  ...
                  <td ><span class="font_blk_b">No records exists.</span>
                      </td>
                </tr>
<%} %>
				<% if(searchString.length()>0)
   {
    %>				
				 <tr>
                    <td align="center" valign="top"></td>
                    <td ><span class="font_bl1_b"><a href="SearchServiceInstances.action" CLASS="set3">Show All Service Instances</a></span> </td>
                      </tr>
	<%} %>	
                  <tr>
                    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
                  ...
                  <tr>
                    <td width="25" align="center" valign="middle"><img src="images/ic_page2.gif" width="14" height="16" /></td>
                    <td class="font_blk_b">
<%				if(records.size()>1)
				{
%>                  
