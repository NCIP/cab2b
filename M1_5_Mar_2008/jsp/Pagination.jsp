...
<%@page import="edu.wustl.cab2b.admin.util.Cab2bConstants"%>
<html>
<head>
...
<%
		...
		int maxPageItems = getParam(request, "maxPageItems", Cab2bConstants.MAX_PAGE_ITEMS);
		int maxIndexPages = getParam(request, "maxIndexPages",Cab2bConstants.MAX_INDEX_PAGES);
