                ...
                <form id="attributesForm" name="attributesForm" method="post" action="AttributeOrder.action">
                  <table width="99%" border="0" cellpadding="4" cellspacing="0">
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top"><select style="width: 200px;" id ="avaliableAttributes" name="avaliableAttributes" size="8" multiple="multiple" class="input_a">
                        ...
                        <td align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td align="center" valign="middle"><input name="Add" type="button" class="font_blk_s" value="&nbsp;&nbsp;&nbsp;Add &gt;&gt;&nbsp;&nbsp;&nbsp;" onClick="AddToSelected();"/></td>
                            </tr>
                            <tr>
                              <td align="center" valign="middle">&nbsp;</td>
                            </tr>
                            <tr>
                              <td align="center" valign="middle"><input name="Remove" type="button" class="font_blk_s" value="&lt;&lt; Remove" onClick="RemoveFromSelected();"/></td>
                            </tr>
                        </table></td>
                        <td align="left">&nbsp;</td>
                        <td align="left" valign="top"><select style="width: 200px;" id ="selectedAttributes" name="selectedAttributes" size="8" multiple="multiple" class="input_a" >
                      ...
                      <tr>
                        ...
                        <td align="center" valign="middle" class="td_grey">&nbsp;</td>
                        <td align="left" class="td_grey">&nbsp;</td>
                        <td colspan="2" align="left" class="td_grey"><input name="add_edit" type="button" id="add_edit"	class="font_blk_s" value="ADD TO DAG" onClick="createQueryStringCab2b()"/></td>
                      </tr>
