						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
                          <form name="attributeOrderForm" id="attributeOrderForm" method="post" action="AttributeOrder.action">
                            <tr>
                              ...
                              <td align="left" valign="middle" background="images/title_bg.gif" class="font_bl3_b">Select&nbsp;&nbsp;</td>
                            ...
                            <tr align="center">
                              <td colspan="2" class="td_orange"><input type="hidden" name="action" value="save" /></td>
...
<%			String css ="td_grey";		
			Map<Integer,List<String>> allAtributes = (Map<Integer,List<String>>) session.getAttribute("attributeList");
				
			Set<Integer> set=allAtributes.keySet();
...
%>						<tr  class="td_grey" id="tr_<%=i%>">
							<td width="0"   ></td>	
                              <td width="1" >&nbsp;<input type="hidden" name="action" value="save"/></td>
                              <td height="40" align="left" valign="middle"><input type="checkbox" name="checkbox22" value="checkbox" id="checkbox_list.get(i)"></td>
                              <td width="1" >&nbsp;</td>                              
...
<%	}
			...
			%>
                        ...
                        <td width="100" align="center"><span class="font_bl2_b"><img src="images/ic_up.gif" alt="Move Up" width="80" height="23" vspace="3" onclick="moveUp();"><br>
                            <img src="images/ic_down.gif" alt="Move Down" width="80" height="23" vspace="3" onclick="moveDown();"></span></td>
                      </tr>
                    </table>                    </td>
                  </tr>
                  <tr>
            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="td_white">
              ...
              <tr>
                  ...
                  <td height="35" align="right" class="td_grey"><input name="Submit2" type="button" class="font_bl1_b" onClick="SubmitForm();" value="Finish" />
                    &nbsp;&nbsp;&nbsp; </td>
                </form>
              </tr>
            </table></td>
