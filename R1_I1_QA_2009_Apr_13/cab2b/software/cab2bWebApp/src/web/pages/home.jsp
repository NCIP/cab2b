	...
	<FORM method="post" action="/search.do" onsubmit="return checkEmptyTextFileld('keywordSearch', keywordSearchExample.value, true)">
		...
		<DIV id="content">
			<DIV id="toppanel">
				...
				<DIV>
					<SELECT class="select" name="modelGroups" onChange="processAJAXRequest('DisplaySavedSearches.do?modelGroups=' + this.value, 'savedsearchespanelbody')" style="margin-right: 1%">
