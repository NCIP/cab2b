...
<BODY onLoad="<logic:notPresent name="homeAction">document.forms[0].action='Home.do';document.forms[0].submit();</logic:notPresent>">
	<FORM method="post" action="/search.do" onsubmit="return checkEmptyTextFileld('keywordSearch', keywordSearchExample.value, true)">
		...
		<DIV id="content">
			<DIV id="toppanel">
				...
				<DIV>
					<SELECT class="select" name="modelGroups" onChange="processAJAXRequest('DisplaySavedSearches.do?modelGroups=' + this.value, 'savedsearchespanelbody')" style="margin-right:2.4em">
			...
			<DIV id="keywordsearchpanel">
				<DIV class="label"><bean:message key="label.keywordsearch"/></DIV> <INPUT type="text" class="textbox examplevalue" name="keywordSearch" value="<bean:message key="textbox.keywordsearch.examplevalue"/>" onFocus="if(keywordSearchExample.value=='')keywordSearchExample.value=this.value;if(this.value==keywordSearchExample.value)this.value='';this.className='textbox'" onBlur="if(this.value=='')this.value=keywordSearchExample.value;if(this.value==keywordSearchExample.value)this.className='textbox exampleValue'"><INPUT type="hidden" name="keywordSearchExample" value="<bean:message key="textbox.keywordsearch.examplevalue"/>"> <INPUT type="submit" class="button" value="<bean:message key="button.keywordsearch"/>">
			</DIV>
