...
alter table DYEXTN_ATTRIBUTE drop foreign key FK37F1E2FF728B19BE;
...
alter table DYEXTN_CONTAINER drop foreign key FK1EAB84E44AC41F7E;
...
alter table DYEXTN_CONTAINMENT_CONTROL drop foreign key FK3F9D4AD351A77A33;
alter table DYEXTN_CONTAINMENT_CONTROL drop foreign key FK3F9D4AD340F198C2;
alter table DYEXTN_CONTROL drop foreign key FK70FB5E8069935DD6;
alter table DYEXTN_CONTROL drop foreign key FK70FB5E807769A811;
...
alter table DYEXTN_ENTITY drop foreign key FK8B243640728B19BE;
alter table DYEXTN_ENTITY_GROUP drop foreign key FK105DE7A0728B19BE;
alter table DYEXTN_ENTITY_GROUP_REL drop foreign key FK5A0D835A4AC41F7E;
alter table DYEXTN_ENTITY_GROUP_REL drop foreign key FK5A0D835A88C075EF;
...
alter table DYEXTN_PERMISSIBLE_VALUE drop foreign key FK136264E05521B106;
...
alter table DYEXTN_TABLE_PROPERTIES drop foreign key FKE608E0814AC41F7E;
