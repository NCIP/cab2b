...
public class CreateCategoryBizLogic {
     ...
     * 
     * @param dagNode
     * @return It retruns the List of all InputCategorialAttribute instance for a paticular InputCategorial instance.
     */
    ...
    public long getParentPathId(long nodeId) {
        ...
        if (path != null)
            return new Long(path.getPathId());
        else 
            return -1L;
    }
    ...
    public List<InputCategorialClass> getInputCategorialClass() {
        ...
        Set<DAGNode> set = map.keySet();
        Iterator<DAGNode> iterator = set.iterator();
