    ...
    public String execute() throws RemoteException, IOException {
        ...
        if (getFormAction() != null) {
            ...
            for (DAGNode dagNode : setOfNodes) {
                ...
                String  nodeName=Utility.parseClassName(EntityCache.getCache().getEntityById(dagNode.getEntityId()).getName());
                for (DAGNode innerDagNode : setOfNodes) {
                String  innerNodeName=Utility.parseClassName(EntityCache.getCache().getEntityById(innerDagNode.getEntityId()).getName());
            ...
            for (DAGNode dagNode : setOfNodes) {
                ...
                for (String attribute : attibutesList) {
                    ...
                    attributes.add(nodeName+" "+ CommonUtils.getFormattedString(attributeName[0]));
                    unFormattedAttributeMap.put(nodeName+" "+ CommonUtils.getFormattedString(attributeName[0]), attributeName[0]);
                }
