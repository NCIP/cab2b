...
public class LoadModel extends BaseAction implements ServletRequestAware, ServletResponseAware, SessionAware,
     ...
     * @param
     * returns map of modelName Vs LoadModelResult 
     */
    public Map<String, LoadModelResult> load() {
        Collection<CaDSRModelDetailsBean> modelsToLoad = (Collection<CaDSRModelDetailsBean>) session.get("ListOfUserModels");
    ...
    /**
     * This method gets List of CaDSRModelDetailsBean from servletcontext and removes the models which are loaded
    ...
    /**
     * This method fetch all the model names from request and session, selected by user for loading. 
    ...
    public String getModelStatus(Map<String, LoadModelResult> loadModelResultMap) {
        ...
        for (String modelName : loadModelResultMap.keySet()) {
            ...
            result = result + ";" + model.getModelDetails().getLongName() + "|" + model.isLoaded() + "|"
