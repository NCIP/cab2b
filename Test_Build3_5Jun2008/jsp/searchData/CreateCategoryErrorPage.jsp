              ...
              <tr>
                <td align="center" valign="middle"><table width="100%" border="0" cellpadding="4" cellspacing="0" bgcolor="#FFFFFF">
                  <form id="form1" name="form1" method="post" action="">
                    <tr>
                      <td height="50" align="center" valign="middle" nowrap="nowrap" ><span class="font_bl1_b"><img src="images/ic_error.gif" alt="Success" width="32" height="32" hspace="5" align="absmiddle"></span><span class="font_bl2_b">Sorry!</span> <span class="font_blk_s">Cannot create new category. <a href="#" class="set4" onClick="showException('${requestScope.exceptionMessage}');">More details</a></span></td>
                      </tr>
                  </form>
                </table></td>
              </tr>
