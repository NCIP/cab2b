...
public class CaDSRModelDetailsBean extends BaseBean implements Comparable<CaDSRModelDetailsBean> {
    ...
    public int compareTo(CaDSRModelDetailsBean bean) {
        String name = new StringBuffer().append(longName).append(version).toString();
        String nameToCompare = new StringBuffer().append(bean.longName).append(bean.version).toString();
