...
public class SaveServiceInstance extends BaseAction implements SessionAware, RequestAware {
    ...
    public String execute() {
        ...
        try {
            new ServiceInstanceBizLogic().saveServiceInstances(selectedServices, user);
    ...
    public Collection<AdminServiceMetadata> getSelectedServiceInstances() {
        List<AdminServiceMetadata> allServiceRecords = (List<AdminServiceMetadata>) getSession().get(ALL_SERVICE_INSTANCES);
