 ...
 *
 */
public class SaveModelGroupAction extends BaseAction {
    ...
    public String execute() {
        ...
        if (selectedEntityGroup.length != 0) {
        ...
        boolean saveValue = new ModelGroupBizLogic().saveModelGroup(modelGroup);
        if (saveValue) {
            returnValue = AdminConstants.SUCCESS;
        } else {
            returnValue = AdminConstants.FAILURE;
        }
       return returnValue; 
    }
}
