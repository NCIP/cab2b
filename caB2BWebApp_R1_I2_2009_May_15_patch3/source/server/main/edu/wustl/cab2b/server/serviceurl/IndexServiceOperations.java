...
public class IndexServiceOperations {
     ...
     */
    static Set<ServiceURLInterface> getServiceURLsfromIndex(String domainModel, String version)
     ...
     * @return
     */
    static Set<ServiceURLInterface> refreshMetadata(Set<ServiceURLInterface> urlsfromDatabase,
     ...
     * @throws RemoteException
     */
    static ServiceURLInterface getMetadata(String serviceUrl, String entityGroupName)
            throws MalformedURIException, RemoteException {
        String urls = CagridPropertyLoader.getIndexServiceUrl();
        DiscoveryClientForMetaData client = new DiscoveryClientForMetaData(urls);
        ...
        return ServiceMetadataProcessor.getServiceMetadata(metadata, serviceUrl, entityGroupName);
    }
     ...
     */
    static ServiceURLInterface merge(ServiceURLInterface urlsFromDatabase, ServiceURLInterface urlsFromIndexService) {
        ...
        String description = urlsFromIndexService.getDescription();
