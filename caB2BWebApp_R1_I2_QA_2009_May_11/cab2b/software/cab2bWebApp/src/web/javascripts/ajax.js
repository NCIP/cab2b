...
{ 
  ...
  httpRequest.onreadystatechange = function(){ 
    ...
    { 
      results = httpRequest.status==200?httpRequest.responseText:"<DIV class='text' style='padding: 0.5em 0.5em 0.5em 0.5em'>Sorry, there was an error in processing your request! Please contact support.</DIV>"; //http.responseXML can be used to get an XML based response, if we need to have some XML output from a server file.
