...
public class TransformedResultObjectWithContactInfo {
     ...
     */
    private Map<String, List<LinkedHashMap<AttributeInterface, Object>>> urlToResultMap = null;
    ...
    public TransformedResultObjectWithContactInfo() {
        this.urlToResultMap = new HashMap<String, List<LinkedHashMap<AttributeInterface, Object>>>();
    }
     ...
     * @param result
     */
    public void addUrlAndResult(String url, List<LinkedHashMap<AttributeInterface, Object>> result) {
        ...
        try {
            List<Map<AttributeInterface, Object>> resultMap = new ArrayList<Map<AttributeInterface, Object>>();
            for (Map<AttributeInterface, Object> recordMap : result) {
                ...
                recordMap.put(attribute, serviceUrlMetadata.getContactName());

                attribute = DomainObjectFactory.getInstance().createStringAttribute();
                attribute.setName("Contact eMail");
     ...
     */
    public List<LinkedHashMap<AttributeInterface, Object>> getResultForUrl(String url) {
     ...
     * @return List<Map<AttributeInterface, Object>>
     */
    public List<LinkedHashMap<AttributeInterface, Object>> getResultForAllUrls() {
        List<LinkedHashMap<AttributeInterface, Object>> collectedResult = null;
        Collection<List<LinkedHashMap<AttributeInterface, Object>>> collectionOfResults = urlToResultMap.values();
        if (collectionOfResults != null) {
            collectedResult = new ArrayList<LinkedHashMap<AttributeInterface, Object>>();
            for (List<LinkedHashMap<AttributeInterface, Object>> result : collectionOfResults) {
