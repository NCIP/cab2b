...
<script>
 function saveAnotherServiceInstance(action)
 {
   ...
   if(action=='yes')
   { 
    frm.action = "LoadServiceModels.action?callFrom=menu";
   }
   else
   {
              ...
              <tr>
                <td align="center" valign="middle"><table width="100%" border="0" cellpadding="4" cellspacing="0" bgcolor="#FFFFFF">
                  <form id="confirmationForm" name="confirmationForm" method="post" action="">
                    <tr>
                      <td height="50" align="center" valign="middle" nowrap="nowrap" ><span class="font_bl1_b"><img src="images/ic_success.gif" alt="Success" width="32" height="32" hspace="5" align="absmiddle">Congratulations Service Instances of </span> <span class="font_bl2_b">${param.serviceName} </span> <span class="font_bl1_b">saved successfully.</span></td>
                      </tr>
                    <tr>
                      <td height="25" align="center" valign="middle" nowrap="nowrap" class="font_blk_s" > Do you want to save another Service Instances</td>
                    </tr>
                    <tr>
