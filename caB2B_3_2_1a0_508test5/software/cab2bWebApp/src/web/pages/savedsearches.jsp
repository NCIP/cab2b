...
<logic:present name="savedSearches">
	<logic:notPresent name="addlimit">
		<logic:iterate name="savedSearches" id="savedSearch" type="edu.wustl.cab2b.common.queryengine.ICab2bQuery">
			<A href="#this" class="link" name="savedquery" id="<bean:write name="savedSearch" property="id"/>" onClick="document.forms[0].queryId.value=this.id;document.forms[0].action='AddLimit.do';document.getElementsByName('keyword')[0].value=document.getElementsByName('keywordSearchExample')[0].value;document.forms[0].submit();"><bean:write name="savedSearch" property="name"/></A>
