	...
	<DIV id="quicklinkspanel">
		...
		<DIV id="quicklinkspanelbody">
			<DIV>
				...
				<IMG alt="<bean:message key="img.alt.bullet"/>" src="images/arrow.jpg" class="bullet"><A href="/cab2b/webpage/jnlp/cab2b_client_webstart.jnlp" CLASS="link">caB2B Client App</A><BR/>
