              ...
              <tr>
                <td align="center" valign="middle"><table width="100%" border="0" cellpadding="4" cellspacing="0" bgcolor="#FFFFFF">
                  <form id="confirmationForm" name="confirmationForm" method="post" action="">
                    <tr>
                      <td height="50" align="center" valign="middle" nowrap="nowrap" ><span class="font_bl1_b"><img src="images/ic_success.gif" alt="Success" width="32" height="32" hspace="5" align="absmiddle">Service URL saved successfully. </span></td>
                      </tr>
                  </form>
                </table></td>
              </tr>
