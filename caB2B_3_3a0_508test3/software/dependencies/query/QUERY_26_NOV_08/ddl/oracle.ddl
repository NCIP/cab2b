...
drop table QUERY_ABSTRACT_QUERY cascade constraints;
...
drop table QUERY_COMPOSITE_QUERY cascade constraints;
...
drop table QUERY_RESULT_VIEW cascade constraints;
...
drop table QUERY_UNION cascade constraints;
...
drop sequence QUERY_OPERATION_SEQ;
...
create table QUERY_ABSTRACT_QUERY (IDENTIFIER number(19,0) not null, QUERY_NAME varchar2(255 char) unique, QUERY_TYPE varchar2(30 char), DESCRIPTION varchar2(1024 char), CREATED_DATE timestamp not null, CREATED_BY number(19,0) not null, primary key (IDENTIFIER));
...
create table QUERY_COMPOSITE_QUERY (IDENTIFIER number(19,0) not null, OPERATION_ID number(19,0), primary key (IDENTIFIER));
...
create table QUERY_COUNT_VIEW (IDENTIFIER number(19,0) not null, COUNT_ENTITY_ID number(19,0), primary key (IDENTIFIER));
...
create table QUERY_DATA_VIEW (IDENTIFIER number(19,0) not null, primary key (IDENTIFIER));
...
create table QUERY_INTERSECTION (IDENTIFIER number(19,0) not null, primary key (IDENTIFIER));
create table QUERY_INTER_MODEL_ASSOCIATION (IDENTIFIER number(19,0) not null, SOURCE_SERVICE_URL varchar2(255 char) not null, TARGET_SERVICE_URL varchar2(255 char) not null, SOURCE_ATTRIBUTE_ID number(19,0) not null, TARGET_ATTRIBUTE_ID number(19,0) not null, primary key (IDENTIFIER));
...
create table QUERY_MINUS (IDENTIFIER number(19,0) not null, primary key (IDENTIFIER));
...
create table QUERY_OPERATION (IDENTIFIER number(19,0) not null, OPERAND_ONE number(19,0), OPERAND_TWO number(19,0), primary key (IDENTIFIER));
create table QUERY_OUTPUT_ATTRIBUTE (IDENTIFIER number(19,0) not null, EXPRESSION_ID number(19,0), ATTRIBUTE_ID number(19,0) not null, PARAMETERIZED_QUERY_ID number(19,0), POSITION number(10,0), DATA_VIEW_ID number(19,0), primary key (IDENTIFIER));
...
create table QUERY_PARAMETERIZED_QUERY (IDENTIFIER number(19,0) not null, primary key (IDENTIFIER));
create table QUERY_QUERY_ENTITY (IDENTIFIER number(19,0) not null, ENTITY_ID number(19,0) not null, primary key (IDENTIFIER));
create table QUERY_RESULT_VIEW (IDENTIFIER number(19,0) not null, primary key (IDENTIFIER));
...
create sequence QUERY_OPERATION_SEQ;
...
create sequence QUERY_VIEW_SEQ;
