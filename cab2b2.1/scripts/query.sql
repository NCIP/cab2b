...
alter table QUERY drop foreign key FK49D20A886AD86FC;
alter table QUERY drop foreign key FK49D20A89E2FD9C7;
alter table QUERY_ARITHMETIC_OPERAND drop foreign key FK262AEB0BE92C814D;
alter table QUERY_ARITHMETIC_OPERAND drop foreign key FK262AEB0BD635BD31;
alter table QUERY_ARITHMETIC_OPERAND drop foreign key FK262AEB0B96C7CE5A;
alter table QUERY_ARITHMETIC_OPERAND drop foreign key FK262AEB0BD006BE44;
alter table QUERY_ARITHMETIC_OPERAND drop foreign key FK262AEB0B7223B197;
alter table QUERY_ARITHMETIC_OPERAND drop foreign key FK262AEB0B687BE69E;
alter table QUERY_BASEEXPR_TO_CONNECTORS drop foreign key FK3F0043482FCE1DA7;
alter table QUERY_BASEEXPR_TO_CONNECTORS drop foreign key FK3F00434848BA6890;
alter table QUERY_BASE_EXPR_OPND drop foreign key FKAE67EAF0712A4C;
alter table QUERY_BASE_EXPR_OPND drop foreign key FKAE67EA48BA6890;
alter table QUERY_COMPOSITE_QUERY drop foreign key FKD453833986AD86FC;
alter table QUERY_COMPOSITE_QUERY drop foreign key FKD453833932224F67;
alter table QUERY_CONDITION_VALUES drop foreign key FK9997379D6458C2E7;
alter table QUERY_CONSTRAINTS drop foreign key FKE364FCFF1C7EBF3B;
alter table QUERY_CONSTRAINT_TO_EXPR drop foreign key FK2BD705CEE92C814D;
alter table QUERY_CONSTRAINT_TO_EXPR drop foreign key FK2BD705CEA0A5F4C0;
alter table QUERY_COUNT_VIEW drop foreign key FK4A5C8BECF17325F;
alter table QUERY_COUNT_VIEW drop foreign key FK4A5C8BEC89DB039E;
alter table QUERY_CUSTOM_FORMULA drop foreign key FK5C0EEAEFBE674D45;
alter table QUERY_CUSTOM_FORMULA drop foreign key FK5C0EEAEF12D455EB;
alter table QUERY_DATA_VIEW drop foreign key FK2A3EA74389DB039E;
alter table QUERY_EXPRESSION drop foreign key FK1B473A8F635766D8;
alter table QUERY_EXPRESSION drop foreign key FK1B473A8F40EB75D4;
alter table QUERY_FORMULA_RHS drop foreign key FKAE90F94D9A0B7164;
alter table QUERY_FORMULA_RHS drop foreign key FKAE90F94D3BC37DCB;
alter table QUERY_INTERSECTION drop foreign key FK2C1FACC0E201AD1D;
...
alter table QUERY_JOIN_GRAPH drop foreign key FK2B41B5D09DBC4D94;
alter table QUERY_MINUS drop foreign key FK7FD7D5F9E201AD1D;
alter table QUERY_OPERATION drop foreign key FKA13E4E70E4553443;
alter table QUERY_OPERATION drop foreign key FKA13E4E70E4554829;
alter table QUERY_OUTPUT_ATTRIBUTE drop foreign key FK22C9DB75E92C814D;
alter table QUERY_OUTPUT_ATTRIBUTE drop foreign key FK22C9DB75F961BE22;
alter table QUERY_OUTPUT_ATTRIBUTE drop foreign key FK22C9DB75604D4BDA;
alter table QUERY_OUTPUT_TERM drop foreign key FK13C8A3D388C86B0D;
alter table QUERY_PARAMETERIZED_QUERY drop foreign key FKA272176B76177EFE;
alter table QUERY_RULE_COND drop foreign key FKC32D37AE6458C2E7;
alter table QUERY_RULE_COND drop foreign key FKC32D37AE39F0A10D;
alter table QUERY_SUBEXPR_OPERAND drop foreign key FK2BF760E8E92C814D;
alter table QUERY_SUBEXPR_OPERAND drop foreign key FK2BF760E832E875C8;
alter table QUERY_TO_OUTPUT_TERMS drop foreign key FK8A70E25691051647;
alter table QUERY_TO_OUTPUT_TERMS drop foreign key FK8A70E2565E5B9430;
alter table QUERY_TO_PARAMETERS drop foreign key FK8060DAD739F0A314;
alter table QUERY_TO_PARAMETERS drop foreign key FK8060DAD7F84B9027;
alter table QUERY_UNION drop foreign key FK804AC458E201AD1D;
