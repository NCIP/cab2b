    ...
    private void executeQuery(IClientQueryBuilderInterface clientQueryBuilder) {
        try {
            ...
            if (!CommonUtils.isServiceURLConfigured(cab2bQuery, mainSearchPanel)) {
                ...
                Collection<FailedTargetURL> failedURLs = queryResults.getFailedURLs();
                String output = "";
                ...
                JOptionPane.showMessageDialog(mainSearchPanel, output,
                		"Failed URLS", JOptionPane.INFORMATION_MESSAGE);*/
            }
        } catch (Exception e) {
