...
public class SaveServiceInstance extends BaseAction {
    ...
    public String execute() {
        ...
        Collection<ServiceURL> selectedServices = getSelectedServiceInstances();
    ...
    public Collection<ServiceURL> getSelectedServiceInstances() {
        ...
        Collection<ServiceURL> selectedServiceMetaData = new HashSet<ServiceURL>();
