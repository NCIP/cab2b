 ...
 * This action class is used to call code to generate dynamic UI for defining conditions on query and forward to the page for adding limits via the generated UI.
 *
 */
public class AddLimitAction extends Action {
    ...
    /**
     * The execute method is called by the struts action flow and it calls the code for generating dynamic HTML for add limit page.
     * @param mapping
     * @param form
     * @param request
     * @param response
