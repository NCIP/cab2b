...
public class DisplaySavedSearchesAction extends Action {
    ...
    private static final Logger logger = edu.wustl.common.util.logger.Logger.getLogger(DisplaySavedSearchesAction.class);

    /**
     * The execute method is called by the struts action flow and it calls the code for setting saved searches parameters required at the pages for displaying saved searches.
     * @param mapping
     * @param form
     * @param request
     * @param response
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        try {
            Collection<EntityGroupInterface> entityGroups = new ModelGroupBizLogic().getEntityGroupsForModel(modelGroupName);
