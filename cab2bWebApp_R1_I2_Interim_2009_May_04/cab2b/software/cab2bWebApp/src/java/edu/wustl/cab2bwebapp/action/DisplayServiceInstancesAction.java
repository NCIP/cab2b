...
public class DisplayServiceInstancesAction extends Action {
    ...
    private static final Logger logger = edu.wustl.common.util.logger.Logger.getLogger(DisplayServiceInstancesAction.class);

    /**
     * The execute method is called by the struts action flow and it calls the code for identifying service instances to be shown.
     * @param mapping
     * @param form
     * @param request
     * @param response
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        try {
            ...
            List<ServiceURLInterface> servicesForSingleModelGroup = appBizLogic.getApplicationInstances(user,
                                                                                                        modelGroupName);
