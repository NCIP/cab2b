...
public class HomeAction extends Action {
    ...
    /**
     * The execute method is called by the struts action flow and it calls the code for setting parameters required at the home page.
     * @param mapping
     * @param form
     * @param request
     * @param response
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        try {
            ...
            Collection<ICab2bQuery> savedSearches = savedQueryBizLogic.getRegualarQueries(modelGroup.getEntityGroupList());
