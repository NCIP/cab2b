...
<BODY onLoad="showFirstQueryForm()">
<FORM method="post" action="ExecuteQuery.do" onSubmit="createQueryString()">
	<jsp:include page="header.jsp"/>
	<DIV id="leftpanel" style="height: 470; width: 21%;">
		...
		<DIV id="definelimitspanelheader">
			<DIV class="titlebar">
				<DIV class="titlebarheader title">
					<DIV class="titlebarleftcurve">
						<DIV class="titlebarrightcurve">
							<bean:message key="title.defineconditionsfor"/> <DIV id="queryname" style="display: inline"></DIV><INPUT type='hidden' name='queryId'>
						</DIV>
					</DIV>
				</DIV>
			</DIV>
