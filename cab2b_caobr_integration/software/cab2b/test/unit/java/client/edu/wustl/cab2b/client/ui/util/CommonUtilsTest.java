...
public class CommonUtilsTest extends TestCase {
	...
	public void testSearchNodeForNull() {
		...
		DefaultMutableTreeNode res = CommonUtils.searchNode(rootNode,
				userObject);
		assertNull(res);
	}
	...
	public void testInitializeResources() {
		...
		String msg = ErrorCodeHandler
				.getErrorMessage(ErrorCodeConstants.DB_0001);
	...
	public void testSetHome() {
		...
		assertEquals(cab2bHome.getAbsolutePath(), System
				.getProperty("cab2b.home"));
	}

	public void testEscapeString() {
		assertEquals("\"aaaaa,bbbbb,ccccc\"", CommonUtils
				.escapeString("aaaaa,bbbbb,ccccc"));
	}

	public void testGetMaximumLabelDimension() {
		AttributeInterface a1 = TestUtil.getAttribute("entity", 1L, "id", 2L);
		AttributeInterface a2 = TestUtil.getAttribute("entity", 3L,
				"geneSourceName", 4L);
		AttributeInterface a3 = TestUtil.getAttribute("entity", 5L, "name", 6L);

		DynamicExtensionUtility.addTaggedValue(a2.getEntity(), TYPE_CATEGORY,
				TYPE_CATEGORY);
	...
	public void testGetRelativeDimension() {
		...
		Dimension result = CommonUtils.getRelativeDimension(referenceDimnesion,
	...
	public void testGetDagImageMap() {
		...
		DagImages[] keys = { DagImages.SelectIcon, DagImages.selectMOIcon,
				DagImages.ArrowSelectIcon, DagImages.ArrowSelectMOIcon,
				DagImages.ParenthesisIcon, DagImages.ParenthesisMOIcon,
				DagImages.DocumentPaperIcon, DagImages.PortImageIcon };
	...
	public void testDisableAllComponent() {
		Container[] components = { new JPanel(), new JPanel(), new JButton(),
				new JButton() };
	...
	public void testHandleExceptionForChecked() {
		CommonUtils.initializeResources();
		Exception exception = new CheckedException("From testcase",
		...
		CommonUtils.handleException(exception, parentComponent,
				shouldShowErrorDialog, shouldLogException,
				shouldPrintExceptionInConsole, shouldKillApp);
	}

	public void testHandleExceptionForWrappedChecked() {
		CommonUtils.initializeResources();
		Exception exception = new RuntimeException(new CheckedException(
				"From testcase", new IllegalArgumentException(),
	...
	public void testHandleExceptionForCab2bRuntime() {
		CommonUtils.initializeResources();
		Exception exception = new edu.wustl.cab2b.common.exception.RuntimeException(
				"From Testcase", ErrorCodeConstants.DB_0001);
		Component parentComponent = null;
		boolean shouldShowErrorDialog = false;
		boolean shouldLogException = false;
