...
public class ServiceInstances extends BaseAction {
    ...
    */
    ...
    public String execute() {
        ...
        List<ServiceURL> allServiceInstances = new ArrayList<ServiceURL>();
        List<ServiceURL> filteredServiceInstances = new ArrayList<ServiceURL>();
        ...
        if (textbox != null && !textbox.equals("")) {
            ...
            allServiceInstances = (List<ServiceURL>) session.get(ALL_SERVICE_INSTANCES);
     ...
     */
    @SuppressWarnings("unchecked")
    private void searchInstancesHavingText(List<ServiceURL> filteredServiceInstances) {
        List<ServiceURL> allServiceInstances;
        allServiceInstances = (List<ServiceURL>) session.get(ALL_SERVICE_INSTANCES);
        filteredServiceInstances.clear();

        // Now fetch each serviceurl metadata for searchString
        for (ServiceURL adminServiceMetadata : allServiceInstances) {
     ...
     */
    @SuppressWarnings("unchecked")
    private void getServiceMetadata(List<ServiceURL> allServiceInstances) {
        try {

            UserInterface user = (UserInterface) session.get(USER_OBJECT);
            Collection<ServiceURL> instanceList = null;
