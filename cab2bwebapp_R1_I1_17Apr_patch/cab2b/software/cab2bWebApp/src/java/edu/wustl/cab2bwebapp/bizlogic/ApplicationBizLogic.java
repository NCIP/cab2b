...
public class ApplicationBizLogic {
    ...
    /**
     * This is the default constructor which initializes the EntityGroupCollection with all EntityGroup present in database 
     */
    ...
    public List<ServiceURLInterface> getApplicationInstances(UserInterface user, String modelGroupName) {
        List<EntityGroupInterface> entityGrpList = new ModelGroupBizLogic().getEntityGroupsForModel(modelGroupName);
        ...
        for (EntityGroupInterface entityGrp : entityGrpList) {
            ...
            List<ServiceURLInterface> serviceURLList = new ServiceURLOperations().getInstancesByServiceName(
                                                                                                            entity[0],
                                                                                                            entity[1],
                                                                                                            user);
        ...
        return Utility.sortServiceInstances(serviceURLInstanceList);
    }
