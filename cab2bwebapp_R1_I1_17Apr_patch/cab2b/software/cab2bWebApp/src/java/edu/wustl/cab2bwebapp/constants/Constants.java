...
public class Constants {
    ...
    public static final String SAVED_QUERY_PROVIDER = "savedQUeryProvider";

    /** Constant for home action */
    ...
    /** Constant for authentication error */
    ...
    /** Constant for logout failure message */
