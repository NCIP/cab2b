...
public interface QueryEngineBusinessInterface extends BusinessInterface {
     ...
     */
    IQueryResult<? extends IRecord> executeQuery(ICab2bQuery query, String dref)
     ...
     * @throws RemoteException if retrieving fails
     */
    Collection<ICab2bQuery> getUsersQueriesDetail(String serializedDCR)
            throws RemoteException;
     ...
     * @throws RemoteException if retrieving fails
     */
    List<ICab2bQuery> retrieveAllQueriesByUser(String serializedDCR) throws RemoteException;
}
