...
public class BioAssayDataRecord extends CaArrayRecord implements IBioAssayDataRecord {
    ...
    public BioAssayDataRecord(Set<AttributeInterface> attributes, RecordId id) {
        super(attributes, id);
    }
