...
/**
 * This class is responsible for sending attributes in Available Attributes and Selected Attributes 
 * back to CreatCategory.jsp while editing DAG Node
 * 
 * @author lalit_chand
 */
public class SearchCategoryBizLogic {
     ...
     * @return
     */
    public String showAttributeInformation(final EntityInterface entity, final DAGNode dagNode) {
        ...
        String allAttributeInfo = nodeName + AdminConstants.ENTITY_NAME_SEPARATOR + entityId
                + AdminConstants.ENTITY_ID_SEPARATOR + "edit" + AdminConstants.OPERATION + availableAttributes
