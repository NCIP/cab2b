...
public class CaDSRLoadModel extends BaseAction implements ServletRequestAware, SessionAware, ServletContextAware {
    ...
    public String execute() {
        ...
        if (this.textbox != null && !this.textbox.equals("")) { //This code is for search model
            ...
            if (this.session.get(ALL_AVAILABLE_MODELS_TO_LOAD) != null) {
                ...
                if (toFetch()) {
                    try {
                        synchronized (this) {
                            boolean isListModelNull = servletContext.getAttribute(AdminConstants.LIST_OF_MODELS) == null ? true
                                    : false;
                            if (isListModelNull) {
                    ...
                    this.allModelList = (List<CaDSRModelDetailsBean>) servletContext.getAttribute(AdminConstants.LIST_OF_MODELS);
                }
    ...
    private boolean toFetch() {
        ...
        long refreshTime = Long.parseLong(ServerProperties.getCadsrRefreshTime());
        boolean isListModelNull = servletContext.getAttribute(AdminConstants.LIST_OF_MODELS) == null ? true : false;
