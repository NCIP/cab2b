...
public class InterModelConnectionsUtil {
     ...
     * @param attributePair the connection to save.
     * @throws IllegalArgumentException if the specified connection already exists.
     */
     ...
     * "eligible connections between two classes from different models"
     ...
     * </ol>
     * @return the (possibly empty) set of eligible connections
    ...
    public static Set<AttributePair> determineConnections(EntityInterface class1, EntityInterface class2) {
        ...
        boolean classesConceptsMatch = areAllConceptCodesMatch(class1.getOrderedSemanticPropertyCollection(),
                                                               class2.getOrderedSemanticPropertyCollection());
        for (AttributeInterface attr1 : class1.getAttributeCollection()) {
            for (AttributeInterface attr2 : class2.getAttributeCollection()) {
                ...
                boolean attributesConceptsMatch = areAllConceptCodesMatch(attr1.getOrderedSemanticPropertyCollection(),
                                                                          attr2.getOrderedSemanticPropertyCollection());
