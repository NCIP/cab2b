...
public class AddLimitPanel extends ContentPanel implements IUpdateAddLimitUIInterface {
	...
	private void initGUI() {
		...
		m_innerPane = new JSplitPane(JSplitPane.VERTICAL_SPLIT, m_topCenterPanel,
				m_bottomCenterPanel);
	...
	public void clearAddLimitUI() {
		...
		resetButton((Cab2bPanel) components[components.length - 1], m_searchResultPanel
				.getAddLimitButtonBottom());
