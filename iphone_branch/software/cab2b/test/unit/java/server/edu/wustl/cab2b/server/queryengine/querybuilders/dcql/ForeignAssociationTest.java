...
public class ForeignAssociationTest extends BaseQueryBuilderTestUtil {
...
//                                                        childExprId, class2);
//        setOperandsOfExpression(childExpressionMock);
//
//        setOperandsOfExpression(parentExpressionMock, childExprId);
//
//        IJoinGraph joinGraph = createJoinGraph(createEdge(
//                                                          parentExprId,
//                                                          childExprId,
//                                                          createForeignAssociation(
//                                                                                   attribute11,
//                                                                                   attribute21,
//                                                                                   "sourceUrl",
//                                                                                   "targetUrl")));
