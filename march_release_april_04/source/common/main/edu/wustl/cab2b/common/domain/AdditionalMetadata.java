 ...
 */
 ...
 /**
  * A base class with a set of attributes that defines 
  * the metadata for the derived experiments, and categories.
  * 
...
public class AdditionalMetadata extends AbstractDomainObject implements java.io.Serializable {
     ...
     * @hibernate.property name="name" type="string" column="AMD_NAME" length="50"
     ...
     * @hibernate.property name="description" type="string" column="AMD_DESCRIPTION" length="50"
     ...
     * @hibernate.property name="lastModifiedOn" type="date" column="AMD_LAST_UPDATED_ON"
