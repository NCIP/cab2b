...
public class NumberTypePanel extends AbstractTypePanel
{
	...
	{
		super(conditionList, attributeEntity, new RiverLayout());
	}
	...
	public ArrayList<String> getValues() 
	{
		...
		{
			if(( 0 == getCondition().compareToIgnoreCase("IN"))||( 0 == getCondition().compareToIgnoreCase("Not IN")))
			{
	...
	private Cab2bFormattedTextField getProperFormattedTextField()
	{
		...
		{
			formattedTextField = new Cab2bFormattedTextField(CAB2B_FORMATTED_TEXT_FIELD_COLUMN_SIZE, Cab2bFormattedTextField.INTEGER_NUMBER_FIELD);
		...
		{
			formattedTextField = new Cab2bFormattedTextField(CAB2B_FORMATTED_TEXT_FIELD_COLUMN_SIZE, Cab2bFormattedTextField.FLOAT_NUMBER_FIELD);
		}else 
		{
			formattedTextField = new Cab2bFormattedTextField(CAB2B_FORMATTED_TEXT_FIELD_COLUMN_SIZE, Cab2bFormattedTextField.WHOLE_NUMBER_FIELD);
		}
	...
	{
		if((0 == condition.compareToIgnoreCase("In"))|| (0 == condition.compareToIgnoreCase("Not In")))
		{
			((Cab2bFormattedTextField)m_NameEdit).setCommaAllowed(true);
		}
		else
