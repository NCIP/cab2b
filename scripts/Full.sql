...
alter table DYEXTN_ENTITY_GROUP drop foreign key FK105DE7A086ABEA7F;
...
alter table DYEXTN_ENTITY_GROUP add index FK105DE7A086ABEA7F (MAIN_CONTAINER_ID), add constraint FK105DE7A086ABEA7F foreign key (MAIN_CONTAINER_ID) references DYEXTN_CONTAINER (IDENTIFIER);
