...
public class LayoutConstants {
    ...
    /**
     * Vertical fill property command name
     */
    ...
    /**
     * Vertical top insect value property command name
     */
    public static final String VTOP = "vtop";

    /**
     * Vertical Center insect value property command name
     */
     ...
     */
    public static final int TAB_SPACE = 5;
}