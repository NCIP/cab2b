...
public class PaginationTagHandler extends TagSupport {
	 ...
	 */
	/**
	 * Overrides {@link PaginationTagHandler#doStartTag()}
	 * 
	 * @return
	 * @throws JspException
	 * 
	...
	public int doStartTag() throws JspException {
		try {
			...
			currentPageNumber = Integer.parseInt((String) request
					.getParameter("currentPage"));

			StringBuffer htmlCode = new StringBuffer(300);
			...
			for (int i = currentPageNumber + 1; i < maxLimit; i++) {
				htmlCode.append("<a href=\"#\" class=\"set4\"> " + i
						+ " </a> | ");
			}
			htmlCode
					.append(" <a href=\"#\" class=\"set4\">Next &gt;&gt;</a></span>");
