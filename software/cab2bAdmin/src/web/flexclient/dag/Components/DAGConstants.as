package Components
{
	public class DAGConstants
	{
		...
		public static  var GENERAL_PATH:String="General Path";
        public static  var SELECTED_PATH:String = "Selected Path";
		public static  var CURATED_PATH:String = "Curated Path"; 
		public static  var DAG_NODE_SET:String = "dagNodeSet"; 
		public static  var DAG_LINK_SET:String = "dagLinkSet"; 
