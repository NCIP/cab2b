        ...
        <td align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td align="left" valign="bottom" background="images/bg_top.gif" class="td_white"><table width="293" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="74"><a href="../home.html" onMouseOut="MM_swapImgRestore();MM_startTimeout()" onMouseOver="MM_swapImage('Image28','','images/home1.gif',1)"><img src="images/home2.gif" alt="Home" name="Image28" width="74" height="23" border="0" id="Image28" /></a></td>
                    ...
                    <td width="108"><a href="#" name="link4" id="link3" onMouseOut="MM_swapImgRestore();MM_startTimeout()" onMouseOver="MM_swapImage('Image12','','images/exp1.gif',1);MM_showMenu(window.mm_menu_1203115052_0,2,23,null,'Image12')"><img src="images/exp1.gif" name="Image12" width="115" height="23" border="0" id="Image12" /></a></td>
                  </tr>
              </table></td>
