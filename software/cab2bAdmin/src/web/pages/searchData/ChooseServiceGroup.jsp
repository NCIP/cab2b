...
<TABLE width="100%">
	...
	<TR>
		<TD align="center" valign="top"><table width="100%" cellpadding="0" cellspacing="0" class="normalTable">
			<TR>
				<TD align="left" valign="top">
						<s:form action="ServiceGroup" >
							<s:iterator value="allQueries"> 
								<div style="color: black; font-size: 12;"><input type="radio" name="selectedQuery" value="<s:property value='id'/>"  /> <s:property value="description"/></div><br/>
    						</s:iterator> 
							<s:submit action="defineServiceGroup" value="Submit" />
						</s:form>
				</td>
			</tr>
		</td>
