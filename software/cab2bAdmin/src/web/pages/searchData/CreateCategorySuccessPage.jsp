              ...
              <tr>
                <td align="center" valign="middle"><table width="100%" border="0" cellpadding="4" cellspacing="0" bgcolor="#FFFFFF">
                  <form id="confirmationForm" name="confirmationForm" method="post" action="">
                    <tr>
                      <td height="50" align="center" valign="middle" nowrap="nowrap" ><span class="font_bl1_b"><img src="images/ic_success.gif" alt="Success" width="32" height="32" hspace="5" align="absmiddle">Congratulations!</span> <span class="font_bl2_b">${param.title} </span> <span class="font_blk_s">created successfully.</span></td>
                      </tr>
                    <tr>
                      <td height="25" align="center" valign="middle" nowrap="nowrap" class="font_blk_s" > Do you want to create another category?</td>
                    </tr>
                    <tr>
                      <td height="45" align="center" valign="top" nowrap="nowrap"  >
                        <input name="yes" type="button" class="font_blk_s" value="Yes" onclick="createNewCategory('new');">
                        &nbsp;&nbsp;
                        <input name="no" type="button" class="font_blk_s" value="No" onclick="createNewCategory('no');">                    </td>
                    </tr>
                  </form>
                </table></td>
              </tr>
