...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top"><table width="100%" cellpadding="0" cellspacing="0" >
      <tr>
        <td colspan="3" align="left" valign="top" class="newtr"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="75" height="35" colspan="4" align="left" valign="top" background="\\"><table width="200" border="0" cellpadding="0" cellspacing="0" class="td_dgrey">
              <tr>
                ...
                <td><img src="images/arrow.gif" width="12" height="11" hspace="5" align="absmiddle" /><span class="font_bl2_b">Curate Paths </span></td>
      ...
      <tr>
        ...
        <td width="1" align="right" class="td_dgrey"><img src="images/spacer.gif" width="1" height="1" /></td>
        <td align="center" valign="top" class="td_white">
		<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td align="left" valign="middle" background="images/title_bg.gif" class="font_bl3_b"><img src="images/c1.gif" width="12" height="24" align="absmiddle" /></td>
			<td align="left" valign="middle" background="images/title_bg.gif" class="font_bl3_b"><input type="hidden" name="entityId" id="entityId" /></td>
			<td align="left" valign="middle" background="images/title_bg.gif" class="font_bl3_b"><input type="hidden" name="CuratePath" id="curate_or_intermodel" /></td>
          ...
          <tr>
            <td colspan="5" align="left" valign="top" class="td_orange"><img src="images/spacer.gif" width="1" height="1" /></td>
          </tr>
        </table>
             <table width="99%" height="350" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="470px">											
											...
											<param name="movie" value="flexclient/dag/DAG.swf"/>
											<param name="quality" value="high" />
												<param name="bgcolor" value="#869ca7" />
												<param name="allowScriptAccess" value="sameDomain"/>
												<embed src="flexclient/dag/DAG.swf?callingPage=CuratePath" quality="high" bgcolor="#869ca7"
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="td_white">
          ...
          <tr>
              ...
              <input  id="isSelected" type="checkbox" value="true"> <span class="font_blk_b">Mark as Selected&nbsp;&nbsp;&nbsp;</span>
              <input name="Submit2" type="submit" class="font_bl1_b" onclick="saveCuratePath()" value="Save Path" />
                &nbsp;&nbsp;&nbsp; 
