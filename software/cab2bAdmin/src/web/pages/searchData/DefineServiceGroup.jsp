...
<TABLE width="100%">
	...
	<TR>
		<TD align="center" valign="top"><table class="normalTable" width="100%" cellpadding="0" cellspacing="0" >
			<TR>
				<TD align="left" valign="top" >
					<div>
						Please define service groups for <s:property value="query.name" /><br/><br/>
						<s:form action="ServiceGroup">
						<table class="instanceTable">
							<tr>
								...
								<th colspan="2">
									Service Instances <input type="button" class="addRow" value="Add Row"/>
								</th>
							</tr>
							<tr>
									<td>
										<s:textfield name="groupNames"  theme="simple"/>
									</td>
									<td>
						...
						<s:submit action="saveServiceGroup" value="Submit" theme="simple"/>
						</s:form>
					</div>
				</td>
			</tr>
