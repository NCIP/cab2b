				...
				<table width="100%" border="0" align="center" cellspacing="0"
							...
							<td height="40" align="center" valign="middle"
								...
								<c:when test="${counter eq 1}">
									<input type="radio" name="selectPair" id="selectPair"
										value="${attributePair.attribute1.id}_${attributePair.attribute2.id}_${attributePair.matchFactor.value}"
										checked />
								</c:when>
								<c:otherwise>
									<input type="radio" name="selectPair" id="selectPair"
					...
					<tr>
						<td height="50" align="center" valign="middle"
							...
							name="selectPair" id="selectPair" value="manual" ${checked}/></label></td>
						<td height="50" align="center" valign="middle"
							bgcolor="${bgcolor}">
