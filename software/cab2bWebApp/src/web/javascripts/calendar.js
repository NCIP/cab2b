...
//            file called "calendar.html". 
//				
//			  See http://www.tarrget.info/calendar/IEnightmare.html for a full explanation.
//
...
// ***************************
    ...
    document.write(
     "<iframe class='scw' " + (scwID('scwIElt7')?"src='/pages/calendar.html '":'') +
