...
public class SearchResultPanel extends Cab2bPanel implements ActionListener {
     ...
     *            refreshing.
     * 
     * @param result The collectiond of entities.
     */
    ...
    /**
     * This method ctreates and returns a hyperlink which will display certain details of all the attributes of the given entity.
     * @param entity
     * @return
     */
    ...
    class AttributeDetailsLinkListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            int i = 0;
            for (AttributeInterface attribute : attributeList) {
                tableData[i][0] = attribute.getName();
