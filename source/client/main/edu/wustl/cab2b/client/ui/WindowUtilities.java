...
//	private static Cursor lastCursor = Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR);
	 ...
	 * @return a configured, packed and located JXFrame
	 */
	public static JXFrame wrapWithScrollingInFrame(JComponent leftComp, JComponent rightComp,
			String title)
	{
	 ...
	 * @return a configured, packed and located JXFrame
	 */
	public static JXFrame showWithScrollingInFrame(JComponent leftComp, JComponent rightComp,
			String title)
	{
	...
	public static final void centerWindow(Window parent, Window w)
	{
		...
		if (((x + w_size.width) > s_size.width) || (x < 0) || ((y + w_size.height) > s_size.height)
				|| (y < 0))
			centerWindow(w);
		else
			w.setLocation(x, y);
...
//	}
	 ...
	 * @return
	 */
	public static JDialog showInDialog(JComponent componentToShow, String title, Dimension size, boolean isReSizable)
	{
	 ...
	 * @return
	 */
	public static JDialog showInDialog(Frame parentFrame, JComponent componentToShow, String title, Dimension size, boolean isModal, boolean isReSizable)
	{
	 ...
	 * @return
	 */
	public static JDialog setInDialog(Frame parentFrame, JComponent componentToShow, String title, Dimension size, boolean isModal, boolean isReSizable)
	{
		JDialog dialog = new JDialog(parentFrame, title, isModal);
		dialog.getContentPane().add(componentToShow);
		if(componentToShow instanceof IDialogInterface)
