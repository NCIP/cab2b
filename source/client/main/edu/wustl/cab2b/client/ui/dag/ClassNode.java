...
public class ClassNode extends GenericNode {
     ...
     * @param port port at given location.
     */
    ...
    /* (non-Javadoc)
     * @see edu.wustl.cab2b.client.ui.dag.GenericNode#createNodeRenderer(org.netbeans.graph.api.control.GraphHelper, org.netbeans.graph.api.model.IGraphNode, boolean)
     */
     ...
     * @param associationIdx source port index
    ...
    /**
     * @param operator Operator between attribute and association
     */
    ...
    /**
     * @param type The type of this class node.
     */
