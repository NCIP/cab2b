...
public class AmbiguityPathResolverPanel extends Cab2bPanel
{
	...
	/**
	 * Vector of source target vectors.
	 */
	private Vector<Vector<EntityInterface>> srcTarCollection;
	...
	{
		this.srcTarCollection = sourceTargetCollection;
		initGUI();
	}
	...
	public static Vector<EntityInterface> getEntityInterfaceFor(String[] searchTerms)
	{
		...
		AdvancedSearchBusinessInterface busInter = (AdvancedSearchBusinessInterface) CommonUtils
				.getBusinessInterface("AdvanceSearch", AdvancedSearchHome.class, null);
		...
		for(int i = 0; i < searchTerms.length ; i++)
		{
			...
			try
			{
				matchedClass = busInter.search(searchTarget, searchString, Constants.BASED_ON_TEXT);
			}
	...
	public static void main(String[] args)
	{
		...
		Logger.out.info("user selected ambigious paths #####>>>>> "+ambiguityPathResolverPanel.getUserSelectedpaths());
