...
public class ExperimentDataCategoryGridPanel extends Cab2bPanel {
    ...
    private void refreshUI() {
        filterPanel = new ApplyFilterPanel(table);
    ...
    final private void addAnalysisViewTabPanel(UserObjectWrapper<EntityRecordResultInterface> userObjectWrapper) {
        ...
        if (analysisView == null) {
            ...
            Map<String, AttributeInterface> attributeMap = new HashMap<String, AttributeInterface>(headerList.size());
            ...
            ExperimentTableModel analysisDataTable = new ExperimentTableModel(false, dataRecordArray, columnNames, attributeMap);
     ...
     */
    private String[] generateColumnNames(List<AbstractAttributeInterface> headerList, Map<String, AttributeInterface> attributeMap) {
