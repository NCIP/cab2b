...
public class NewExperimentPanel extends Cab2bPanel implements ActionListener
{
    ...
    public NewExperimentPanel()
    {
        ...
        //Create the tabs
        tabbedPane.add(ApplicationProperties.getValue("cab2b.experiment.newexp.expdetailstab.text"), new NewExperimentDetailsPanel());
        tabbedPane.add(ApplicationProperties.getValue("cab2b.experiment.newexp.datalisttab.text"), new ExperimentDataSelectionPanel(myDataList));
        tabbedPane.add(ApplicationProperties.getValue("cab2b.experiment.newexp.summarytab.text"), new ExperimentSummaryPanel(expSummary));
    ...
    public static void main(String[] args)
    {
        ...
        NewExperimentPanel demo = new NewExperimentPanel();
        JFrame frame = new JFrame("Create New Experiment");
