...
public class GlobalNavigationPanel extends Cab2bPanel implements ActionListener {
	...
	private void initGUIWithGB() {
		...
		/*
		 * gbc.gridx = 11; gbc.gridy = 1; gbc.gridwidth = 1; gbc.gridheight = 1;
		 * gbc.fill = GridBagConstraints.VERTICAL;
	...
	public static void main(String[] args) {
		...
		// JFrame frame = WindowUtilities.openInJFrame(globalNavigationPanel,
		// 1024, 70, "Global Navigation Panel");

		JXFrame frame = WindowUtilities.showInFrame(globalNavigationPanel,
