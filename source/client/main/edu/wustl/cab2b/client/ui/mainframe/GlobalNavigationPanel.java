...
public class GlobalNavigationPanel extends Cab2bPanel implements ActionListener
{
	...
	private void initGUIWithGB()
	{
		...
		Date date = new Date();
		loggedInUserLabel = new Cab2bLabel(
		"<html>Robert Lloyd <br>" + DateFormat.getDateInstance(DateFormat.LONG).format(date).toString() + "<br><br></html>");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		/*			mainSearchPanel = new MainSearchPanel();					
					...
					//WindowUtilities.showInDialog(frame, searchPanel, "Search Data", new Dimension(
					//		1200, 900), true, true);
					
					WindowUtilities.showInDialog(frame, mainSearchPanel, "Search Data", new Dimension((int)(dimension.width * 0.90), (int)(dimension.height * 0.85)), true, true);
					mainSearchPanel.dataList.clear();
