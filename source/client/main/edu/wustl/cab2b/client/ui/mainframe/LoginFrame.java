...
public class LoginFrame extends JXFrame {
    ...
    private Font getTextFont() {
        ...
        return new Font(label.getFont().getName(), Font.BOLD, label.getFont().getSize() - 1);
    }

    public void initUI() {
        Font font = getTextFont();

        Cab2bTitledPanel titledPanel = new Cab2bTitledPanel("ca Bench To Bedside (B2B)");
        titledPanel.setTitleFont(new Font(font.getName(), Font.BOLD, font.getSize() + 6));
        ...
        MattePainter painter = new MattePainter(new GradientPaint(0f, 0f, color1, 0f, 25f, color2));
        ...
        this.setLocation(screenSize.width / 2 - (labelSize.width / 2), screenSize.height / 2
                - (labelSize.height / 2));
