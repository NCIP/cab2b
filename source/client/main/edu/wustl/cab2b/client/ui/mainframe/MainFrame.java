...
public class MainFrame extends JXFrame {
	...
	public MainFrame(String title, boolean exitOnClose) {
		...
		lefthandStackedBox.setDataForPopularSearchCategoriesPanel(CommonUtils
	...
	public static void launchMainFrame(String userName) {
		...
		try {
			...
			clientLauncher.launchClient(getUserName());

			MainFrame mainFrame = new MainFrame(ApplicationProperties.getValue(MAIN_FRAME_TITLE),
					true);
			mainFrame.pack();
