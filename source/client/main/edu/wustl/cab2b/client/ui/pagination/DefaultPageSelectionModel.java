...
//		}
	...
	public static void main(String[] args)
	{
		...
		System.out.println("bitset lenght "+bitset.length());
		//bitset.get
		//PageSelectionModel pageSelectionModel = new DefaultPageSelectionModel(null);
		
		//int selectionCount = pageSelectionModel.getSelectionCount();
		//Logger.out.info("selection count "+selectionCount);
		
		//Vector selectedPageIndeices = pageSelectionModel.getSelectedPageIndices();
		//Logger.out.info("selected page indices "+selectedPageIndeices);
	}
