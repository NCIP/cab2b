...
public class TransformCategoryResult {
    ...
    private void setRecordsToB2BTreeNode(B2BTreeNode parentTreeNode,
        ...
        while (recordIter.hasNext()) {
            ...
            Logger.out.info("Set DisplayName :" + iCategorialClassRecord.getCategorialClass().toString());

            //record node
            B2BTreeNode iCategorialClassRecordNode = new B2BTreeNode();
            iCategorialClassRecordNode.setDisplayName(iCategorialClassRecord.getCategorialClass().toString());
