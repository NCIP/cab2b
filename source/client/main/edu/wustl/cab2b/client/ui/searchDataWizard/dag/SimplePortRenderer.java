    ...
    public void renderPort(IGraphPort port, Graphics2D gr, int layer) {
        ...
        if (layer == LAYER_PORT && visible) {
            ...
            if (dn != null) {
                ...
                gr.setColor(nodeSelected ? SimpleDocumentRenderer.getSelectionBackgroundColor()
                        : SimpleDocumentRenderer.getPaperColor());
                gr.setColor(nodeSelected ? IconNodeRenderer.getFontShadowSelectedColor()
                        : IconNodeRenderer.getFontShadowColor());
        ...
        if (rectangle.contains(position) && nameEditable != null && nameEditable.canRename()) {
            return new TextFieldEditor() {
                public String getValue() {
                    ...
                    return name != null ? name : NbBundle.getMessage(SimplePortRenderer.class,
                                                                     "TXT_SimplePortDriver_EnterName"); // NOI18N
                }
