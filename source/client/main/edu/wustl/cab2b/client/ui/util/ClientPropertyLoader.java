...
public class ClientPropertyLoader {
    private static Properties props = Utility.getPropertiesFromFile("client.properties");
    ...
    * 
    * @param idP
    * @return returns the target grid certificate ,needed for generating Globus certificate for user
    */
