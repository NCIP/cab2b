		...
		if (isExtraColumnAdded()) {
			...
			for (int rowIndex = 0; rowIndex < rowCount
				...
				for (int columnIndex = 0; columnIndex < tableModel
					...
					if (isUserColumnDefined(tableModel
						...
						newAttribute.setName(tableModel
								.getColumnName(columnIndex));
						mapAttributeValue.put(newAttribute, tableModel
	...
	class ShowRecordDetailsListener implements PropertyChangeListener {
		public void propertyChange(PropertyChangeEvent evt) {
			if (evt.getPropertyName().equals(
				...
				firePropertyChange(DISABLE_CHART_LINK, evt.getOldValue(), evt
						.getNewValue());
			}
