...
public class ExperimentOperations extends DefaultBizLogic {
	...
	public void addExperiment(Long experimentGroupId, Experiment experiment)
			throws BizLogicException, UserNotAuthorizedException, DAOException {
		ExperimentGroup experimentGroup = new ExperimentGroupOperations()
				.getExperimentGroup(experimentGroupId);
	...
	public EntityInterface saveDataCategory(String title, List<AttributeInterface> attributes,
		...
		DynamicExtensionUtility.addTaggedValue(newEntity,
				edu.wustl.cab2b.common.util.Constants.FILTERED, "true");
		...
		AssociationInterface association = DynamicExtensionUtility.createNewOneToManyAsso(
		...
		try {
			...
			throw (new RuntimeException(e.getMessage(), e,
					ErrorCodeConstants.DATACATEGORY_SAVE_ERROR));
	 ...
	 * 
	 */
	private void persistData(EntityInterface entity, List<AttributeInterface> attributes,
			Object[][] data) throws DynamicExtensionsSystemException,
