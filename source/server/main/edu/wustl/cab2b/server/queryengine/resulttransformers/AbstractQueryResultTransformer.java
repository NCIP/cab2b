 ...
 * implementation need only to implement the <code>createRecords</code> and
...
public abstract class AbstractQueryResultTransformer<R extends IRecord, C extends ICategorialClassRecord>
     ...
     *            custom logger.
     */
    protected AbstractQueryResultTransformer(DcqlLogger dcqlLogger) {
